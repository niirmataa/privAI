...
fn load_seed_valid() -> SealedPacket {
...
#[test]
fn decrypt_seed_valid_json_outside_libfuzzer() {
    let sealed = load_seed_valid();
    ...
    .expect("seed_valid.json should decrypt outside libFuzzer");

    assert_eq!(plaintext, br#"{"kind":"tx_sign_req","data":"c-fuzz-seed"}"#);
}
